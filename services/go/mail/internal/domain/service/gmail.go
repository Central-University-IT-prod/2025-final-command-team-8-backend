...
func NewMailServiceFromEnv() mailService {
	from := dotenv.GetEnv("MAIL_EMAIL", "hackathonrazoom@gmail.com")
	password := dotenv.GetEnv("MAIL_PASSWORD", "mtzb xlns ilue spog")
	smtpHost := dotenv.GetEnv("MAIL_HOST", "smtp.gmail.com")
